...
namespace Tcp4
{
    public class UIVirtualJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            OutputPointerEventValue(ConvertToVector3(outputPosition * magnitudeMultiplier));
        ...
        {
            OutputPointerEventValue(Vector3.zero);
        ...
        private void OutputPointerEventValue(Vector3 pointerPosition)
        {
            ...
            OnMove?.Invoke(new Vector2(pointerPosition.x, pointerPosition.z));
        }
